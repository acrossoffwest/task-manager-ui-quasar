    ...
    <transition name="fade">
      <div v-if="showInput">
        <select
          v-if="type === 'select'"
          name=""
          :class="`block appearance-none w-full  ${$color('input')} ${$color(
            'borderMain'
          )} border px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline ${
        ...
        <textarea
          :class="`shadow appearance-none border rounded w-full py-2 px-3 ${$color(
            'input'
          )} ${$color(
            'borderMain'
        ...
        <input
          ...
          :id="name"
          :type="type"
          :class="`shadow ${$color('input')} ${$color(
            'borderMain'
